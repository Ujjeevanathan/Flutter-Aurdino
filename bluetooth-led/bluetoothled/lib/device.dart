              ...
              children: [                
                ListTile(                  
                  ...
                  onTap: () async {
                    ...
                    for (BluetoothCharacteristic characteristic in e.characteristics) {
                      final isWrite = characteristic.properties.write;
                      if (isWrite) {
                      await characteristic.write("off".codeUnits);
                      }
                    }                      
                    //await e.characteristics[1].write("0".codeUnits);
                  },
                ),
                ListTile(
                  title: Text("ON"),
                  onTap: () async {
                    ...
                    for (BluetoothCharacteristic characteristic in e.characteristics) {
                      final isWrite = characteristic.properties.write;
                      if (isWrite) {
                      await characteristic.write("on".codeUnits);
                      }
                    }  
                  },
                ),
